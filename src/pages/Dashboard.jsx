...
import { Play, Pause, SkipForward, SkipBack, Shuffle, Repeat, LogOut, Trash2, Heart, MoreVertical, Plus, X, Radio, Disc3, Music } from 'lucide-react'
...
export default function Dashboard() {
  ...
  // Array of sleek dark gradients for the "Explore" cards
  const cardGradients = [
  ...
  return (
    <div className="min-h-screen bg-[#090909] text-white font-sans pb-40 overflow-x-hidden selection:bg-green-500 selection:text-black">
      ...
      <div className="max-w-md md:max-w-4xl mx-auto p-6">
        ...
        {/* EXPLORE SECTION (Horizontal Cards based on Reference) */}
                ...
                <div key={item.id} onClick={() => playTrack(originalIndex, currentListType)}
                  ...
                  <div className="flex items-center gap-4 overflow-hidden w-full">
                    ...
                    <div className="overflow-hidden pr-2">
                      ...
                      <p className={`text-xs truncate mt-0.5 font-medium ${item.is_radio ? 'text-green-500/70' : 'text-gray-500'}`}>{item.artist}</p>
                    </div>
                  </div>
